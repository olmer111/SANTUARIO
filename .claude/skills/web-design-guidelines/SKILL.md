...
description: Auditoría de UI contra las Web Interface Guidelines de Vercel (100+ reglas de accesibilidad, foco, formularios, animación, performance). Usar al terminar cada pantalla; corregir todo hallazgo crítico antes de darla por lista.
---
